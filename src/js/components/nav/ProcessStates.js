...
const ProcessStates = createReactClass({
    selectState: function (e) {
        e.preventDefault();
        const itemsState = e.currentTarget.getAttribute("data-items-state");
    ...
    render: function () {
        let states = Object.keys(this.props.states).map((stateName) => {
