...
class DateRange extends React.Component {
    ...
    handleChange(e) {
        const limit = e.target.getAttribute("data-limit"), newState = {};
        const start = limit === "start" ? e.target.value : this.state.start;
        const end = limit === "end" ? e.target.value : this.state.end;
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextState.userInput) {
            this.setState({ userInput: false });
            return true;
        }

        return this.props.shouldComponentUpdate ? this.props.shouldComponentUpdate(nextProps, nextState) : false;
    }
